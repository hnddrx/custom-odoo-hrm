...
class DisciplinaryAction(models.Model):
    ...
    offense = fields.Many2one('offense.lists', string='Offense List', required=True)
    offense_description = fields.Char(string='Offense Description', readonly=True, store=True)
